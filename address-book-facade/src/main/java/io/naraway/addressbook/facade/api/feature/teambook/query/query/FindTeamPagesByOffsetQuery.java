...
@NoArgsConstructor
@AllArgsConstructor
public class FindTeamPagesByOffsetQuery extends QueryRequest<List<AddressPage>> {
    //
    ...
    public static FindTeamPagesByOffsetQuery fromJson(String json) {
        //
        return JsonUtil.fromJson(json, FindTeamPagesByOffsetQuery.class);
    }

    public static FindTeamPagesByOffsetQuery sample() {
        //
        return new FindTeamPagesByOffsetQuery(
